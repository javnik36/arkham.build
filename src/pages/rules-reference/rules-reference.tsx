...
/** biome-ignore-all lint/security/noDangerouslySetInnerHtml: generated */
...
<nav class="inner rop">
<ul>
<li><a href="#Intro">A Note from ArkhamDB</a></li>
  <ul>
  <li><a href="#The_Thing_That_Should_Not_Be">The Thing That Should Not Be...</a></li>
  <li><a href="#The_Golden_Rules">The Golden Rules</a></li>
  <li><a href="#The_Grim_Rule">The Grim Rule</a></li>
  <li><a href="#The_Silver_Rule">The Silver Rule</a></li>
  </ul>
<li><a href="#Glossary">Glossary</a></li>
  ...
  <li><a href="#Ability">Ability</a></li>
    ...
    <li><a href="#Switch_And_Swap_Abilities">"Switch" and "Swap" Abilities</a></li>
    </ul>
  <li><a href="#Act_Deck_and_Agenda_Deck">Act Deck and Agenda Deck</a></li>
  <li><a href="#Action">Action</a></li>
    <ul>
    <li><a href="#Only_As_Your_First_Action">"...only as your first action"</a></li>
    <li><a href="#Take_An_Action_Vs_Perform_An_Action">"Take an action" vs "Perform/resolve an action"</a></li>
    <li><a href="#Basic_Action_Types">Basic Action Types</a></li>
    <li><a href="#Gaining_Spending_And_Forfeiting_Actions">Gaining, Spending, and Forfeiting Actions</a></li>
    </ul>
  ...
  <li><a href="#Attach_To">Attach To</a></li>
    <ul>
    <li><a href="#Control_of_Attachments">Control of Attachments</a></li>
    <li><a href="#Moving_Attachments">Moving Attachments</a></li>
    <li><a href="#Controlling_and_Attaching_Permanent_Cards">Controlling and Attaching Permanent Cards</a></li>
    </ul>
  ...
  <li><a href="#Campaign_Play">Campaign Play</a></li>
    ...
    <li><a href="#Transferring_Investigators_to_a_New_Campaign">Transferring Investigators to a New Campaign</a></li>
    </ul>
  ...
  <li><a href="#Chaos_Tokens">Chaos Tokens</a></li>
    <ul>
    <li><a href="#Bless_and_Curse_Tokens">Bless and Curse Tokens</a></li>
    <li><a href="#Frost_Tokens">Frost Tokens</a></li>
    <li><a href="#Resolving_Multiple_Revealed_Chaos_Tokens">Resolving Multiple Revealed Chaos Tokens</a></li>
    </ul>
  <li><a href="#Checkpoints">Checkpoints</a></li>
  <li><a href="#Choices_and_the_Grim_Rule">Choices, and the Grim Rule</a></li>
  <li><a href="#Clues">Clues</a></li>
    <ul>
    <li><a href="#Clues_on_Player_Cards">Clues on Player Cards</a></li>
    </ul>
  <li><a href="#Collection">Collection</a></li>
  <li><a href="#Concealed_X">Concealed X</a></li>
  <li><a href="#Concealed_Mini_Cards">Concealed Mini-Cards</a></li>  
  <li><a href="#Constant_Abilities">Constant Abilities</a></li>
  <li><a href="#Control">Control</a></li>
  <li><a href="#Copy">Copy</a></li>
  <li><a href="#Costs">Costs</a></li>
    <ul>
    <li><a href="#Ignoring_All_Costs">"Ignoring all costs"</a></li>
    </ul>
  ...
  <li><a href="#Deckbuilding">Deckbuilding</a></li>
    ...
    <li><a href="#Deckbuilding_Options">Deckbuilding Options</a></li>
    </ul>
  ...
  <li><a href="#Doubt_and_Conviction">Doubt and Conviction</a></li>
  ...
  <li><a href="#Farthest_From_All_Investigators">"Farthest from all investigators"</a></li>
  ...
  <li><a href="#For_Each_Or_For_Every">"For each" or "for every"</a></li>
  ...
  <li><a href="#Hidden">Hidden</a></li>
    <ul>  
    <li><a href="#Hidden_Cards_in_Hand_When_Eliminated">Hidden Cards in Hand When Eliminated</a></li>
    </ul>
  ...
  <li><a href="#Joes_Hunch_Deck">Joe's "Hunch Deck"</a></li>
  <li><a href="#Keys">Keys <i>(Innsmouth)</i></a></li>
  <li><a href="#Keys2">Keys <i>(Scarlet Keys)</i></a></li>
  ...
  <li><a href="#Limits_and_Maximums">Limits and Maximums</a></li>
    <ul>  
    <li><a href="#Limits_Pertaining_to_Play_Areas">Limits Pertaining to Play Areas</a></li>
    </ul>
  <li><a href="#Location_Cards">Location Cards</a></li>
    <ul>  
    <li><a href="#Being_at_No_Location">Being at No Location</a></li>
    </ul>
  ...
  <li><a href="#Multiclass_Cards">Multi-class Cards</a></li>
  ...
  <li><a href="#Prologue_Investigators">Prologue Investigators</a></li>
  ...
  <li><a href="#Replacing_an_Opening_Hand">Replacing an Opening Hand</a></li>  
  ...
  <li><a href="#Revelation">Revelation</a></li>
    <ul>
    <li><a href="#Dilemmas_and_Revelation_Abilities">Dilemmas and Revelation Abilities</a></li>
    <li><a href="#Revelation_Ability_Priority">Revelation Ability Priority</a></li>
    </ul>
  <li><a href="#Sanity_and_Horror">Sanity and Horror</a></li>
  <li><a href="#Seal">Seal</a></li>
  <li><a href="#Search">Search</a></li>
    <ul>
    <li><a href="#Looking_At_Searching_And_Finding">"Looking at," "Searching," and "Finding"</a></li>
    <li><a href="#Searching_During_Setup">Searching During Setup</a></li>
    </ul>
  ...
  <li><a href="#Skill_Test_Results_and_Advanced_Timing">Skill Test Results and Advanced Timing</a></li>
  <li><a href="#Skill_Tests">Skill Tests</a></li>
  <li><a href="#Slots">Slots</a></li>
    <ul>
    <li><a href="#Shifting_Slots">Shifting Slots</a></li>
    </ul>
  <li><a href="#Spawn">Spawn</a></li>
    <ul>  
    <li><a href="#Spawning_an_Enemy">Spawning an Enemy</a></li>
    </ul>
  <li><a href="#Standalone_Mode">Standalone Mode</a></li>
  <li><a href="#Story_Cards">Story Cards</a></li>
  <li><a href="#Supplies">Supplies</a></li>
  <li><a href="#Surge">Surge</a></li>
  <li><a href="#Swarming X">Swarming X</a></li>
  <li><a href="#Taking_Damage_Horror">Taking Damage/Horror</a></li>
  <li><a href="#Target">Target</a></li>
  <li><a href="#Tarot Slot">Tarot Slot</a></li>
  ...
  <li><a href="#Treachery_Cards">Treachery Cards</a></li>
    <ul>
    <li><a href="#Treachery_Subtitles">Treachery Subtitles</a></li>
    </ul>
  <li><a href="#Triggered_Abilities">Triggered Abilities</a></li>
  <li><a href="#Triggering_Condition">Triggering Condition</a></li>
  <li><a href="#Unique">Unique</a></li>
  <li><a href="#unless_all_clues_have_been_discovered">"...Unless all of (location's) clues have been discovered."</a></li>
  ...
  <li><a href="#Weakness">Weakness</a></li>
                <ul>  
    <li><a href="#Weakness_Events_And_Changing_The_Game_State">Weakness Events and "changing the game state"</a></li>
    </ul>
  <li><a href="#When">When</a></li>
  <li><a href="#Wild_Skill_Icons">Wild Skill Icons</a></li>
  ...
  <li><a href="#You_Your">You/Your - Expanded</a></li>
    <ul>  
    <li><a href="#Interpreting_You_When_Taking_or_Being_Dealt_Damage">Interpreting "You" When Taking or Being Dealt Damage</a></li>
    </ul>
  </ul>
...
<blockquote><em>The most merciful thing in the world, I think, is the inability of the human mind to correlate all its contents.</em><br>
...
<li>  For any given timing point, all forced abilities initiated in reference to that timing point must resolve before any [reaction] abilities (see below) referencing the same timing point in the same manner may be initiated.</li>
...
<p>A triggered ability is any ability prefaced by either a [free] icon, a [reaction] icon, or an [action] icon. If the ability has one or more prerequisites (costs and/or conditions), these are listed in text immediately following the icon. A player must always meet the prerequisites of a triggered ability in order to trigger that ability. There are three types of triggered abilities:</p>

<p>Free triggered abilities ([free]) – A [free] triggered ability may be triggered as a player ability during any player window. (See "<a href="#Appendix_II_Timing_and_Gameplay">Appendix II: Timing and Gameplay</a>" on page 22 for a complete list of player windows.)</p>

<p>Reaction triggered abilities ([reaction]) – A [reaction] triggered ability with a specified triggering condition may be triggered any time that triggering condition is met. <em>For example: "[reaction] After you defeat an enemy:"</em></p>

<ul>

<li>  A [reaction] ability with a triggering condition beginning with the word "when..." may be used after the specified triggering condition initiates, but before its impact upon the game state resolves.</li>

<li>  A [reaction] ability with a triggering condition beginning with the word "after..." may be used immediately after that triggering condition's impact upon the game state has resolved.</li>

<li>  Each [reaction] ability may be triggered only once each time the specified condition on the ability is met. <em>For example, an ability that is triggered "After X occurs," may be used once each time "X" occurs.</em></li>

</ul>

<p>Action triggered abilities ([action]) – An [action] triggered ability may be triggered during a player's turn in the investigation phase through the use of the activate action, and only if the player uses one action for each [action] specified in the ability's cost.</p>
...
<p>Prey instructions inform which investigator an enemy pursues and/or engages if it has a choice (see "<a href="#Prey">Prey</a>" on page 17).
...
<p><i>For example, if an investigator swaps places with an enemy via Ethereal Slip, they are considered to have left their location and entered the other, but are not considered to have moved for the purposes of card effects such as Buried Secrets.</i></p>
...
<p>If an action qualifies as more than one of an investigator’s additional actions, he or she may choose which additional action is used.</p>

<p>If an effect causes an investigator to lose one or more actions, that investigator has that many fewer standard actions to take that turn (the investigator’s three standard actions are the ones that are "lost" first). If an investigator only has additional actions remaining, those are then lost, in an order of the investigator’s choosing.</p>

<p><i>For example: An effect causes Daisy to lose two actions. She has two fewer standard actions to take during her turn. She cannot choose to "lose" her additional action unless it is the only action she has remaining.</i></p>
...
<p><b>Activate</b>, <b>Play</b>, <b>Resign</b>, and <b>Parley</b> are not basic actions.</p>
...
<p><i>Note: Investigators <b>always</b> begin the game with 3 actions.</i></p>
...
<p>When this action is taken, the investigator initiates an ability that specifies one or more [action] icons as part of its ability cost. The number of [action] icons in the ability's cost determines how many actions the investigator is required to use for this activate action. When performing an activate action, all of that action's costs are simultaneously paid. Then, the consequences of that action resolve.</p>
...
<p><i>For example: “Ashcan” Pete is at the Miskatonic Quad and activates Duke’s second ability, which reads: "[action] Exhaust Duke: <b>Investigate</b>. You investigate with a base skill of 4. You may move to a connecting location immediately before investigating with this effect.” Pete pays the cost to activate this ability, which is spending one action and exhausting Duke. Then Pete resolves the ability, first moving to the Orne Library, followed by investigating. The Orne Library, however, reads: “You must spend 1 additional action to investigate the Orne Library.” This adds an additional cost that must be paid in order to investigate the Orne Library. This additional cost is paid when the investigate action would resolve, outside the normal timing point for paying costs. If Pete cannot spend the additional action, that aspect of Duke’s effect fails to resolve.</i></p>
...
<li>  The game state is considered to be altered throughout the duration of the indicated ability or action, from its initiation (including the paying of its costs, attacks of opportunity, etc) through the resolution of each aspect of its effect, and up until its completion.</li>

<li>  Other card abilities or game effects resolved during this duration are also resolved with the altered game state in mind.</li>

<li>  The game state is not physically altered in any way. (e.g. if you are considered to be at a location, you do not move your mini-card to that location, enemies at that location do not automatically move to your threat area, etc.)</li>

</ul>

<p><i>For example: Luke Robinson wants to play Preposterous Sketches, but is at a location with no clues. One of the locations next to him has a clue on it, so he uses his ability to play Preposterous Sketches as if he were at that location and engaged with each enemy at that location. The game state is considered to be altered in this way throughout the playing of Preposterous Sketches, from its initiation to its resolution. Among other things, this might mean: (a) if there is an enemy at that location, playing Preposterous Sketches would provoke an attack of opportunity, (b) if that location has an ability that would alter the cost of playing the card, it would do so, and (c) other card abilities that might trigger from Luke drawing 1 or more cards would do so as if he were at that connecting location and engaged with that enemy, and so on and so forth. Once Preposterous Sketches has finished resolving and is placed in the discard pile, Luke is no longer considered to be at that location and engaged with each enemy at that location.</i></p>
...
<li>  If an investigator attaches a player card to a player card he or she controls, he or she retains control of the attachment.</li>

<li>  If an investigator attaches a player card to a player card another investigator controls, that other investigator takes control of the attachment.</li>

<li> If a player card with 1 or more player attachments changes control, the card’s new controller takes control of those player attachments.</li>

<li> If an investigator attaches a player card to an encounter card, he or she retains control of the attachment (but does not gain control of the attached encounter card).</li>

<li> A card with the permanent keyword cannot be chosen to be attached to another player card unless explicitly stated.</li>
...
<p><i>For example: an investigator cannot attach Sin-Eater to Elle Rubash even if Sin-Eater has one or more doom on it.</i></p>
...
<p><b>(Here begin the expanded rules. NB this section overrules some of what is above.)</b> Some card effects make an investigator automatically succeed or automatically fail a skill test. If this occurs, depending on the timing of such an effect, certain steps of the skill test may be skipped in their entirety.</p>
...
<li>  If an ability "automatically evades" 1 or more enemies, this is not the same as automatically succeeding at an evasion attempt. As per the entry on "Evade" in the Rules Reference (see "<a href="#Evade">Evade</a>"), if an ability automatically evades 1 or more enemies, no skill test is made for the evasion attempt whatsoever. Consequentially, because no skill test is made, it is not considered a "successful" evasion. The investigator simply follows the steps for evading an enemy (exhausting it and breaking its engagement).</li>

</ul>

<p><i>For example: Patrice uses the ability on Hope, which reads: "[action] If Hope is ready, exhaust or discard him: <b>Evade.</b> Attempt to evade with a base [agility] value of 5. (If you discarded Hope, this test is automatically successful.)" If Patrice chooses to discard Hope, the skill test automatically succeeds before chaos tokens are revealed; therefore Steps 3 and 4 of the skill test are skipped. However, the skill test still takes place. Cards may still be committed to the test, and the investigator’s total modified skill value is still determined, as it may have some bearing on other card abilities. However, if Patrice instead uses the ability on Stray Cat, which reads: "[fast] Discard Stray Cat: Automatically evade a non-<b>Elite</b> enemy at your location," no skill test is made whatsoever.</i></p>
...
<p>If your deck contains a card that summons one or more bonded cards, those bonded cards are set aside at the start of each game.</p>

<p>If a weakness with the bonded keyword is added to an investigator's deck, hand, threat area, or play area, it does not remain a part of that investigator's deck for the rest of the campaign (unlike other weaknesses). It starts each game set aside with that investigator's other bonded cards.</p>
...
<p><i>Note: The standard rules of the game dictate that players start each campaign with a clean state (new decks and 0 experience). The following is an optional variant that is likely to affect the game’s balance. Only intrepid investigators who wish to embrace the chaos should choose this option.</i></p>

<p>When transferring one or more investigators from a completed campaign to a new campaign, players should observe the following rules:</p>

<ul>

<li>  Not all surviving investigators in the original campaign need to be transferred. It is okay to transfer some and start fresh with others.</li>

<li>  Investigator decks remain the same. This includes all story assets and weaknesses earned in the original campaign, as well as experience gained and trauma suffered. Everything recorded in the campaign log under that investigator’s "Earned Story Assets / Weaknesses" should be transferred to the new campaign, as well.</li>

<li>  All other notes in the Campaign Log should be wiped clean and do not transfer to the new campaign.</li>

<li>  The chaos bag is reset. This includes all additional chaos tokens that were added to the chaos bag throughout the original campaign.</li>

<li>  If an investigator has an ability that occurs "at the beginning of the campaign," or "at deck creation," such as Father Mateo’s bonus experience, it does not trigger a second time upon transferring that investigator into a new campaign.</li>

<li>  Cards and Campaign Guides are written with the assumption that investigators are not being transferred from one campaign to another. For this reason, campaigns are sometimes referred to as "the campaign." <i>(For example, "for the remainder of the campaign...")</i> In general, when interpreting such effects, treat each campaign as being separate from one another. However, some effects should be interpreted as if each campaign played is part of one continuous uninterrupted campaign. This includes rules that dictate how an earned weakness or story asset operates, or additional rules that a specific investigator must follow. <i>(For example, "for the remainder of the campaign, the bearer of X weakness must only speak in French.")</i></li>
...
<li>  If an ability causes a card to change its cardtype, it loses all other cardtypes it might possess and functions as would any card of the new cardtype.</li></ul></p>
...
<p>[skull] [cultist] [elder_thing] [tablet] – If any of these tokens are revealed for a skill test, resolve the effect for that symbol as indicated on the scenario reference card for the current scenario.</p>

<p>[auto_fail] – This is the auto-fail token. If this token is revealed for a skill test, it indicates the investigator automatically fails the test (see "<a href="#Automatic_Failure_Success">Automatic Failure/Success</a>" on page 5).</p>

<p>[elder_sign] – This is the elder sign token. If this token is revealed for a skill test, resolve the [elder_sign] effect on the investigator card belonging to the player performing the skill test.</p>
...
<li>  [bless] tokens revealed during a skill test have the following effects: "+2. Reveal another token. Instead of returning this token to the chaos bag, return it to the token pool."</li>

<dd> No more than 10 total [bless] tokens can be included in the chaos bag or sealed on cards in play at any given time.</dd>

<li>  [curse] tokens revealed during a skill test have the following effects: "–2. Reveal another token. Instead of returning this token to the chaos bag, return it to the token pool."</li>

<dd> No more than 10 total [curse] tokens can be included in the chaos bag or sealed on cards in play at any given time.</dd>

<li>  [bless] or [curse] tokens revealed outside of a skill test have no effect on their own unless otherwise specified by a card effect.</li>
...
<li>  <i>Do [bless] and [curse] tokens have a modifier or value if they are revealed outside of a skill test?</i> No. [bless] and [curse] tokens revealed outside of a skill test have no modifier or value.</li>

<li>  <i>If adding a certain number of [bless] or [curse] tokens to the chaos bag is part of an ability's effect, and there are not enough [bless] or [curse] tokens remaining to fulfill that effect, what happens?</i> You perform as much of the ability as you can, adding [bless] or [curse] tokens until there are none left to add.</li>

<li>  <i>If adding a certain number of [bless] or [curse] tokens to the chaos bag is part of a card/ability's cost, and there are not enough [bless] or [curse] tokens remaining to fulfill that cost, what happens?</i> If the cost cannot be paid, the card/ability therefore cannot be played/triggered.</li>

<li>  <i>During a campaign, do [bless] and [curse] tokens remain in the chaos bag from scenario to scenario?</i> No, [bless] and [curse] tokens do not carry over from scenario to scenario.</li>

<li>  <i>When exactly are [bless] and [curse] tokens removed from the chaos bag? Are they still present in the chaos bag during the resolution of a scenario?</i> [bless] and [curse] tokens should be removed from the chaos bag when the game is cleaned up after the resolution of a scenario. This occurs before moving onto any subsequent story interludes, unless otherwise noted. - FAQ, v.2.0, August 2022</li>
...
<li> The first [frost] token revealed from the chaos bag during a skill test has the following effect: "–1. Reveal another token." If another [frost] token is revealed from the chaos bag during the same test, immediately end the "reveal chaos tokens" step of the skill test and resolve the test as an automatic failure. <i>(Return all revealed [frost] tokens to the chaos bag after the test ends.)</i></li>

<dd> <i>For example: Bob investigates a location and there are two [frost] tokens in the chaos bag. During Bob's first investigation attempt, he reveals a [frost] token. This reduces his skill value by 1 and causes him to reveal another token. The next token he reveals is a +1, resulting in a total of 0 from both tokens. Bob succeeds! Emboldened, Bob attempts to investigate a second time. This time, he reveals a [frost] token, followed by a second [frost] token. Bob must immediately stop revealing tokens and resolve the investigation as an automatic failure.</i></dd>

<li> No more than eight total [frost] tokens can be included in the chaos bag and/or sealed on cards in play at any given time.</li>

<li> A [frost] token revealed outside of a skill test has no effect on its own unless otherwise specified by a card effect.</li>

<li> A [frost] token added to the chaos bag remains in the chaos bag from scenario to scenario unless removed by a card or game effect. Use the "Chaos Bag" section of the Campaign Log to record which tokens are currently in the chaos bag.</li>
...
<p>When a scenario includes one or more concealed enemies, investigators are instructed to set aside several concealed mini-cards. These mini-cards are double-sided. The facedown side represents the possible location of a concealed enemy. The revealed side reveals the mini-card’s true nature - an enemy’s true location, or simply a decoy.</p>

<p>When an investigator draws an enemy with the concealed X keyword (or is instructed to resolve an enemy’s concealed keyword), they spawn that enemy into a game area above the agenda deck, not at any location. This area is called "the shadows," and represents enemies the investigators know exist somewhere on the map, but are unsure where. Then, that investigator takes the set-aside concealed mini-card that matches that enemy, along with X decoys (where X is defined by that enemy’s concealed X value), shuffles them facedown, and puts them into play distributed as evenly as possible among each location in play, starting with the locations nearest to them. Then, at each of those locations that already had 1 or more concealed mini-cards, they shuffle each of them facedown as well.</p>

<p><i>For example: Amina draws Coterie Agent (A), which has "concealed 2." She first spawns the Coterie Agent into the shadows. Then, she takes the set-aside Coterie Agent (A) mini-card, along with 2 decoys, shuffles them facedown, and places one at each of the three locations nearest to her. Then, if any of those locations already had 1 or more concealed mini-cards, she would shuffle each concealed mini-card at those locations, as well.</i></p>

<p>Enemies in the shadows observe the following additional rules:</p>

<ul>

<li>  Enemies in the shadows are considered to be in play, but not at any particular location. They cannot move until they leave the shadows.</li>

<li>  Enemies in the shadows can qualify as the "nearest" enemy, but only if there are no other enemies in play at any location.</li>

<li>  Enemies in the shadows cannot be damaged or leave play via player card effects.</li>
...
<li>  Concealed mini-cards are not enemies and cannot be engaged like enemies. However, any investigator at the same location as a concealed mini-card may attempt to expose it by successfully attacking it or evading it (as if it were an engaged enemy), or by successfully investigating its location. The difficulty to successfully attack or evade a concealed mini-card is equal to the shroud value of its location.</li>

<ul>

<li>  An investigator may also use a card effect that automatically evades an enemy, deals damage to an enemy, or discovers a clue at a location in order to instead expose a concealed mini-card.</li>

</ul>

<li>  If an investigator chooses to expose a concealed mini-card, that effect replaces the standard effects of the action or ability that exposed it. <i>(i.e., if an enemy’s mini-card is exposed by evasion or damage, the matching enemy is not evaded, nor does it take damage. If a mini-card is exposed by discovering clues or investigating, no clues are discovered.)</i></li>

<li>  If a concealed mini-card is exposed (via any of the above methods), flip it to its revealed side.

<ul>

<li>  If it is a decoy, set it aside, out of play, with no effect.</li>

<li>  If it is an enemy’s mini-card, that enemy is now exposed. Place the matching enemy in the shadows at that mini-card’s location, then set that mini-card aside, out of play. <i>(That enemy is no longer in the shadows, and is now at the location where its mini-card was located).</i> Then, if there are no other enemies in the shadows, set all remaining concealed mini-cards in play aside, out of play.</li>

</ul>

</li><li>  Only one concealed mini-card may be exposed per effect unless explicitly stated. (i.e., an effect that deals 3 damage to each enemy at a location does not expose all concealed mini-cards at that location; only one.)</li>
...
<p>Each customizable card starts at level 0 and has a separate sheet containing a checklist of upgrades that can be purchased using experience points. Each upgrade is accompanied by one or more checkboxes.</p>

<p>Unless otherwise specified by a card effect, an investigator can only mark checkboxes on an upgrade sheet before or after a scenario, when they are upgrading their deck or purchasing new cards for their deck. Spending 1 point of experience allows an investigator to mark one checkbox on one of their cards’ upgrade sheets.</p>

<p>To purchase an upgrade, an investigator must mark all of an upgrade’s checkboxes. Once an upgrade is purchased, <i>each copy</i> of the card it is paired with is treated as having that upgrade (as a gained card ability) for that investigator only.<p>

<p><i>For example, Hunter’s Armor has the following upgrade: “Durable. Hunter’s Armor gets +2 health.” If 1 experience point is spent to check off one of the two boxes next to Durable, the upgrade is not yet purchased. After both boxes are marked (costing a total of 2 experience points), the upgrade is purchased, and each copy of Hunter’s Armor in that investigator’s deck is affected by the upgrade.</i></p>

<ul>

<li>  A customizable card’s level is equal to half the total number of checkboxes marked on its upgrade sheet, rounded up. <i>(For example, a customizable card with three marked checkboxes is a level 2 card. Spending 3 experience to mark three more checkboxes would make it a level 3 card.) Note that this means some investigators are not able to upgrade a customizable card past a certain point, if their deckbuilding options would forbid them from including the card in their deck after the upgrade is made.</i></li>

<li> An upgrade sheet cannot have more than a total of 10 checkboxes marked. <i>(This means that the maximum number of experience points that may be spent on a particular customizable card is 10, and its maximum level is 5.)</i></li>

<li>  Spending experience points on one or more upgrades for a customizable card already in an investigator’s deck is considered to be "upgrading" a card for the purposes of card effects.</li>

<li> An investigator may directly purchase one or more copies of a new customizable card with one or more upgrades by spending only the amount of experience points required to purchase those upgrades. <i>(Doing so counts as purchasing a new card, not upgrading an existing card.)</i></li>

<li>  Upgrades for customizable cards are considered to be present on a card at all times (even while the card is in an out-of-play area, such as an investigator’s hand or discard pile).</li>

<li>  Spending 1 or more experience points on upgrades on a customizable card’s upgrade sheet is permanent and cannot be refunded.</li>

<li>  During gameplay, upgrade sheets should be placed in an out-of-play area nearby, so they can be quickly referenced. <i>(Alternatively, if playing with opaque card sleeves, investigators may sleeve the upgrade sheet behind the card it modifies, so they can quickly access it whenever they need.)</i></li>

<li>  Additional printer-friendly upgrade sheets can be downloaded and printed from <a href="www.FantasyFlightGames.com">Fantasy Flight Games</a>.</li>
...
<p>Some cards have different effects depending on whether the scenario takes place during the Day or Night. Text following a (<b>Day</b>) or (<b>Night</b>) keyword is only active if the scenario or prelude being played is during the Day or Night, respectively. Any other ability not preceded by these keywords is active regardless of the time period.</p>

<p>Setup instructions may have specific instructions depending on the current day and time. <i>(e.g.</i> "If it is <b>Day 2</b>, put River Hawthorne into play at the Cranberry Bog" <i>only applies when playing that scenario as a</i> <b>Day 2</b> <i>scenario and not a</i> <b>Night 2</b> <i>scenario).</i></p>
...
<p> See also "<a href="#Interpreting_You_When_Taking_or_Being_Dealt_Damage">Interpreting "You" When Taking or Being Dealt Damage</a>".</p>
...
<li>  This rule also applies if an effect alters an investigator’s deck size, deckbuilding restrictions, or deckbuilding options such that 1 or more cards must be removed from or added to their deck as a result.</li>
...
<p>Guardians ([guardian]) feel compelled to defend humanity, and thus go out of their way to combat the forces of the Mythos. They have a strong sense of duty and selflessness that drives them to protect others, and to hunt monsters down.</p>

<p>Mystics ([mystic]) are drawn to and influenced by the arcane forces of the Mythos. Many have spell-casting abilities, able to manipulate the forces of the universe through magical talent.</p>

<p>Rogues ([rogue]) are self-serving and out for themselves. Wily and opportunistic, they are always eager for a way to exploit their current situation.</p>

<p>Seekers ([seeker]) are primarily concerned with learning more about the world and about the Mythos. They wish to research forgotten lore, map out uncharted areas, and study strange creatures.</p>

<p>Survivors ([survivor]) are everyday people in the wrong place at the wrong time, simply trying to survive. Ill-prepared and ill-equipped, Survivors are the underdogs, who rise to the occasion when their lives are threatened.</p>
...
<p>Some card abilities refer to "different" actions or "different" abilities. An ability or action is different from another ability/action if the two are non‑identical abilities, separate abilities on the same card, or abilities on two different cards. <i>(e.g. the two separate fight abilities on Sledgehammer are different from one another, however identical fight abilities on two copies of Machete are not different from one another, nor are two basic fight actions).</i></p>

<ul>

<li>  The exception to this rule is locations. Separate location cards are, by their very nature, not the same location. Therefore, multiple copies of locations with the same title are still considered to be different locations.</li>
...
<p>Later in the campaign, some scenarios may be changed or altered depending on whether the investigators "have more <b>Doubt</b> than <b>Conviction</b>" or "have more <b>Conviction</b> than <b>Doubt</b>." The investigators have more <b>Doubt</b> than <b>Conviction</b> if the number of boxes filled in next to <b>Doubt</b> is greater than the number of boxes filled in next to <b>Conviction</b> (and vice versa). <b>Doubt</b> and <b>Conviction</b> are shared among all of the investigators, and they are not tied to any specific investigator. <b>Doubt</b> and <b>Conviction</b> have no game effect except when explicitly referenced by the Campaign Guide or by a card effect.</p>
...
<li>  The cards he or she controls in play and all of the cards in his or her out-of-play areas (such as hand, deck, discard pile) are removed from the game.</li></ol></p>
...
<li>  All clue tokens that player possesses are placed at the location the investigator was at when he or she was eliminated, and all of that player's resource tokens are returned to the token pool.</li>
...
<p>To evade an enemy engaged with an investigator, that investigator makes an agility test against the enemy's evade value (see "<a href="#Skill_Tests">Skill Tests</a>" on page 18).</p>
...
<p>"Explore" abilities instruct you to draw the top card of the "exploration deck," which is a separate deck that is constructed during the setup of some scenarios. This deck consists of several single-sided locations and treachery cards.</p>

<ul>

<li> Each "Explore" ability indicates a particular type of location that you are seeking to draw. <b>If a location of that type is drawn, it is put into play, and you move to that location.</b> This is considered a "successful" exploration. 

</li><li> If any other location is drawn, place it next to the exploration deck, and draw the next card from the exploration deck. Repeat this process until a location of the indicated type is drawn, or a treachery is drawn. After this action has ended, shuffle each location next to the exploration deck back into the exploration deck. 

</li><li> If a treachery card is drawn, it is resolved as normal. If it is discarded, place it in the encounter discard pile as you would normally. There is no discard pile for the exploration deck. This is considered an "unsuccessful" exploration.

</li><li> As a single-sided location is put into play from the exploration deck, place clues on that location equal to its clue value.
...
<p><i>For example: Location A is 5 connections away from investigator A and 1 connection away from investigator B. Location B is 3 connections away from investigator A and 4 connections away from investigator B. Location B is therefore the farthest from both investigators, because the total distance for each investigator to get to location B is higher than location A. (This is true even though location A is farther from investigator A.)</i></p>
...
<li>  If a location becomes partially flooded, place a flood token on it with the partially flooded side faceup to designate this.</li>

<li>  If a location becomes fully flooded, place a flood token on it with the fully flooded side faceup (or if it is already partially flooded, flip its flood token over) to designate this.</li>

<li>  If a location's flood level is "increased," it changes from unflooded to partially flooded, or from partially flooded to fully flooded. A fully flooded location cannot have its flood level increased.</li>

<li>  If a location's flood level is "decreased," it changes from fully flooded to partially flooded, or from partially flooded to unflooded. If a location becomes unflooded, remove its flood token</li>

<li>  For the purposes of card effects, both partially flooded locations and fully flooded locations are considered to be "flooded."</li>
...
<li>  <i>If an investigator starts their turn at a fully flooded location, enters an unrevealed location with no flood token, and that location becomes flooded "after it is revealed," does the investigator still "struggle for air?" Or does this count as entering an unflooded location?</i> Technically the investigator has entered an unflooded location, which then became flooded after it was revealed, so they would not struggle for air.</li>
...
<p><i>For example: A treachery card instructs you to "take 1 horror for each point you fail by." Since you can calculate how many points you fail by and resolve the dealt horror simultaneously, it should be resolved as a single instance of horror.</i></p>

<p>A different treachery card instructs you: "For each point you fail by, you must either lose 1 action or take 1 horror. This treachery must be resolved as separate effects; each point failed by requires you to make a choice, whether that choice is to lose an action or to take a horror. Each instance must be resolved separately, even if the resulting outcome only causes you to take horror.</p>
...
<p>A location is "haunted" for the purposes of other card effects if it has at least one "<b>Haunted</b> –" ability (printed or otherwise).</p>
...
<li>  While a hidden treachery is in your hand, treat it as if it were in your threat area. Its constant abilities are active, and abilities on it can be triggered, but only by you.</li>

<li>  While a hidden enemy is in your hand, it is not considered to be engaged with you or in your threat area, and it does not attack unless otherwise specified. However, its constant abilities are active, and abilities on it can be triggered, but only by you.</li>

<li>  A hidden card counts toward your hand size, but it cannot leave your hand by any means except those described on the card.</li>
...
<p>Key tokens have two sides. When facedown, all seven keys have the same universal key symbol, so they can be randomized without the investigators knowing which is which. When faceup, each key is color coded with a unique color (<i>red</i>, <i>blue</i>, <i>green</i>, <i>yellow</i>, <i>purple</i>, <i>black</i>, <i>white</i>).</p>

<p>If a scenario uses one or more keys, the setup of that scenario indicates how many are set aside and whether they should be faceup or randomized facedown. Keys can enter play via several different card effects, and they are usually placed on an enemy, location, or story asset. Keys can be acquired in any of three ways:</p> 

<ul>

<li>  If a location with a key on it has no clues, an investigator may take control of each of the location's keys as a [free] ability.</li>

<li>  If an investigator causes an enemy with a key on it to leave play, that investigator must take control of each of the keys that were on that enemy. (If it leaves play through some other means, place its keys on its location.)</li>

<li>  Some card effects may allow an investigator to take control of keys in other ways.</li>

</ul>

<p>When an investigator takes control of a key, they flip it faceup (if it is facedown) and place it on their investigator card. If an investigator who controls one or more keys is eliminated, place each of their keys on their location. As an [action] ability, an investigator may give any number of their keys to another investigator at the same location.</p>
...
<li>  During the resolution of a scenario, a key may become bound to a single bearer, whose name is marked in the Campaign Log. A key may be bound to an investigator, a story asset, or an enemy.</li>

<li>  A key always enters play attached to its bearer (as marked in the Campaign Log). At the start of each scenario, each investigator who is the bearer of 1 or more keys attaches those keys to their investigator card. Whenever a story asset or enemy enters play, if it is the bearer of 1 or more keys, those keys also enter play attached to their bearer.</li>

<ul>

<li>  If a key’s bearer is an investigator or a story asset, it enters play <b><i>Stable</i></b> side faceup.</li>

<li>  If a key’s bearer is an enemy, it enters play <b><i>Unstable</i></b> side faceup.</li>

</ul>

<li> A key cannot leave play unless its bearer leaves play. If the bearer of 1 or more keys leaves play, each key they control is set aside, out of play. <i>(Those keys do, however, remain bound to their bearer for future scenarios unless explicitly noted otherwise.)</i></li>

<li>  While a key is attached to an investigator, that investigator may trigger its shift ability during any player window as a [free] ability. This is called "shifting" the key. As part of this ability’s resolution, it will instruct the investigator to flip the key to its other side, so its other shift ability is active. The investigator will then have to perform the shift ability on its <b><i>Unstable</i></b> side in order to flip it back over again.</li><li>

<ul>

<li>  While a key is attached to a story asset, it may be shifted by any investigator who controls that asset in the same way.</li>

<li>  Each key (by title) attached to an investigator or story asset can only be shifted once per round.</li>

</ul>

</li><li>  While a key is under an enemy’s control, its shift ability only resolves when a card or game effect instructs an investigator to shift that key, after which it remains <b><i>Unstable</i></b> side faceup.

<ul>

<li>  A key attached to an enemy cannot be flipped to its <b><i>Stable</i></b> side.</li>

<li>  There is no limit to the number of times a key attached to an enemy can be shifted.</li>

</ul>

</li><li>  Some card effects may directly flip a key attached to an investigator or story asset from its <b><i>Stable</i></b> side to its <b><i>Unstable</i></b> side, or vice versa. This is not the same as shifting a key, and does not resolve its shift ability.</li>
...
<p><i>Note: "Limit X per investigator" is a limit that pertains to an investigator’s play area.</i></p>
...
<li>  The first time a location is entered by an investigator, that location is revealed by turning it to its other side and placing a number of clues on it equal to its clue value (this may occur during setup). Most clue values are conveyed as a "per investigator" ([per_investigator]) value.</li>
...
<li>  If an investigator moves to an unrevealed location, that location is revealed by turning it to its other side, and placing a number of clues on it equal to its clue value. Most clue values are conveyed as a "per investigator" ([per_investigator]) value.</li>
...
<p>If an investigator has limited access to one of the classes on a multi-class card and unlimited access to one of the other classes on that card, it will still occupy one of the investigator’s limited slots unless their deckbuilding options contains the word "other" in it <i>(see <a href="#Deckbuilding_Options">Deckbuilding Options</a>)</i>.

<p>The following section clarifies how multi-class cards operate depending on how an investigator’s deckbuilding options are presented.</p>

<ul>

<li>  <b>Investigators with unlimited access to more than one class <i>(i.e. All Core Set investigators, Minh Thi Phan, Sefina Rousseau, William Yorick, Leo Anderson, Joe Diamond, Preston Fairmont, Diana Stanley)</i>:</b> A multi-class card can be included in that investigator’s deck if it falls into <i>either</i> of the listed classes.</li>

<li>  <b>Investigators from The Dunwich Legacy expansion <i>(i.e. Zoey Samaras, Rex Murphy, Jenny Barnes, Jim Culver, "Ashcan" Pete)</i>:</b> A multi-class card will not occupy one of these investigator’s five "out of class" slots if one of its classes is the class they have unlimited access to. A card cannot take up more than one "out of class" slot, regardless of how many class icons the card bears.</li>

<li>  <b>Investigators with unlimited access to one class and limited access to one or more "other" classes <i>(i.e. Marie Lambeau, Finn Edwards, Carolyn Fern, investigators from Edge of the Earth)</i>:</b> A multi-class card will not occupy one of the investigator’s limited slots, because it falls into the unlimited category <i>(see <a href="#Deckbuilding_Options">Deckbuilding Options</a>)</i>.</li>

<li>  <b>Lola Hayes:</b> A multi-class card will count as a card of each of its classes toward her Deckbuilding Requirement.</li>
...
<p><i>For example: Ursula performing an investigate action. As part of this investigate action, she must perform an [intellect] test. During the resolution of that skill test, she plays Expose Weakness, a fast event which initiates another [intellect] test. Instead of resolving the second [intellect] test during the first one, the initiation of the second [intellect] test is delayed until after the first skill test (and therefore the investigate action) has finished resolving.</i></p>
...
<li> At the start of each scenario in this campaign, each investigator is given the option to choose a partner asset and put it into play. Partner assets cannot be added to an investigator’s deck. An investigator may choose a different partner (or no partner) to bring each time they are given this choice.</li>

<li> A partner asset cannot leave play unless it is defeated (for example, it cannot be discarded by card effects unless it is explicitly defeated). If an investigator is defeated, any partner asset they have with them is also defeated.</li>

<li> If a partner asset is defeated, remove it from the game. Then, cross off that character’s name in the Expedition Team section of the Campaign Log.</li>
...
<p>When the [per_investigator] symbol appears after a value, that value is multiplied by the number of investigators who started the scenario.</p>
...
<li>  A card with the permanent keyword cannot leave play (except by elimination).</li>

<li>  Once added to your deck, permanent cards cannot be removed from your deck or swapped out of your deck unless explicitly stated otherwise.</li>

</ul>

<p>See also: "<a href="#Controlling_and_Attaching_Permanent_Cards">Controlling and Attaching Permanent Cards</a>".</p>
...
<p>If an ability replaces an investigator’s opening hand with a number of cards "kept" from a larger set of cards, an effect which alters the number of cards in that investigator’s opening hand alters both the cards originally drawn to replace that opening hand, and the number of cards "kept" from that larger set.</p>
...
<p>To be included in an investigator's deck, a card with the Researched keyword must first be "identified" or "translated" by performing a task on the lower level version of that card and recording the result in your Campaign Log.

<ul>

<li> You can only include a researched card in your deck by upgrading it from its lower level version.</li>

<li> You may only include a researched card in your deck if, in your Campaign Log, you have recorded the completion of the task described in the lower level version of that card.</li>

<li> After an investigator has completed this task and recorded it in the Campaign Log, any investigator in that campaign may upgrade the relevant card following the normal rules for upgrading player cards.</li>

</ul>

<p><i>For example, Archive of Conduits (Gateway to Tindalos) has the "Researched" keyword. Therefore, an investigator cannot purchase Archive of Conduits (Gateway to Tindalos) directly. They must instead upgrade it from Archive of Conduits (Unidentified), and they can only do so if they have "identified the gateway."</i></p>
...
<li>  These cards have no cost (“–”). These cards cannot be played; their effects only resolve when they are drawn or added to your hand.</li>

<li>  After resolving a revelation ability on a player card, place it in its owner’s discard pile.</li>

<li>  Revelation abilities do not resolve during setup. If one or more player cards with revelation abilities are drawn during setup, wait until the game begins, then each player (in player order) resolves all of their own revelation abilities in the order of their choosing.</li><li>
...
<li>The number of each signature card listed under an investigator's "Deckbuilding Requirements" is the exact number of copies of that card that is to be included in that investigator’s deck. If no number is specified, that number is 1.<br>
...
<li>Signature cards need not abide by typical deckbuilding restrictions, and do not count toward any deckbuilding limitations if other cards share the same title.</li>
...
<p>[reaction] or <b>Forced</b> abilities with a triggering condition dependent upon the skill test being successful or unsuccessful (such as "After you successfully investigate," or "After you fail a skill test by 2 or more") do not trigger at this time. These abilities are triggered during Step 6, "Determine success/failure of skill test."</p>

<h2 id="Skill_Tests">Skill Tests</h2>

<p>A number of situations in the game require an investigator to make a skill test, using one of his or her four skills: willpower ([willpower]), intellect ([intellect]), combat ([combat]), or agility ([agility]). A skill test pits the investigator's value in a specified skill against a difficulty value that is determined by the ability or game step that initiated the test. The investigator is attempting to match or exceed this difficulty value in order to succeed at the test.</p>
...
<table>
<tbody><tr>
  <td colspan="2" align="center">[accessory_inverted] 1 accessory slot</td>
</tr>
<tr>
...
<p><i>For example: Kōhaku has Occult Reliquary in play when he plays Blessed Blade. He chooses to have Occult Reliquary grant him a hand slot to hold Blessed Blade. If he later plays another Blessed card, such as Hallowed Mirror, he can choose to have the new card take up the additional slot and define the slot type, while he moves Blessed Blade to his default hand slot.</i></p>
...
<p>2. If an investigator draws an enemy, check to see if the enemy has a "Spawn –" instruction.

<ul>

<li>  If the enemy has a "Spawn –" instruction, the enemy spawns at the indicated location. After spawning the enemy at that location, it will automatically engage investigators at its location using the rules for "<a href="#Enemy_Engagement">Enemy Engagement</a>", unless it is aloof.</li>

<li>  If the enemy does not have a "Spawn –" instruction, the investigator drawing the enemy spawns it engaged with him/her, unless it is aloof.</li>

</ul>

<p><b>"Prey –" instructions have no direct impact on which location an enemy will spawn at.</b> The only time "Prey –" instructions will impact this process is when an enemy spawns unengaged at a location with multiple investigators, and you use the rules for "<a href="#Enemy_Engagement">Enemy Engagement</a>" to determine which investigator it should automatically engage.</p>
...
<li>If it is ever unclear which investigator should add swarm cards, the lead investigator does so.</li>

<li>Each swarm card underneath the host enemy acts as a separate instance of that enemy for most purposes. Each swarm card has the same values and text as its host card. <i>(For example, if an investigator is engaged with a host enemy with 2 swarm cards underneath it, that investigator is engaged with 3 enemies in total.)</i></li>

<li>Each swarm card attacks separately when enemies attack during the enemy phase. Once the host enemy and all of its swarm cards have attacked during this step, exhaust all of them.</li>

<li>Each swarm card can be attacked or dealt damage separately, but the host enemy cannot be defeated while it still has swarm cards underneath it. When a swarm card is defeated, any excess damage may be dealt to another swarm card underneath the same host enemy or to the host enemy itself. <i>(For example, Tony Morgan uses a .41 Derringer to attack a Stealthy Zoog with 2 swarm cards. The attack deals 2 damage. The first point of damage defeats 1 of the 2 swarm cards, so the excess point of damage may be dealt to another swarm card, defeating it as well.)</i></li>

<li>Anytime a swarm card leaves play, place it on the bottom of its owner's deck. If you are unsure of the owner of the swarm card, you may look at it to determine its owner.</li>

<li>The host enemy and all of its swarm cards move, engage, and exhaust as a single entity. <i>(For example, if a host enemy or any of its swarm cards are evaded, all of them exhaust and become disengaged.)</i></li>
...
<p>As with other slots, tarot slots limit the number of asset cards of that slot type an investigator is permitted to have in play simultaneously.</p>

<p><b>By default, an investigator has only one tarot slot available.</b></p>
...
<p>Like normal weaknesses, if one of these cards is added to an investigator’s deck, it becomes part of that deck and stays with that investigator from scenario to scenario. However, the resolution of each Tekeli-li! weakness instructs the investigator to return it to the Tekeli-li deck (removing it from their own deck). As a result, the number of cards in the Tekeli-li deck varies based on how many of these weaknesses are in each investigator’s deck.</p>

<p><i>Note: While all Tekeli-li! cards share the same title, they may have differing effects.</i></p>
...
<li>  The [free] icon indicates a free triggered ability that does not cost an action and may be used during any player window.</li>

<li>  The [reaction] indicates a reaction triggered ability that does not cost an action and may be used any time its triggering condition is met.</li>
...
<p> An investigator is permitted to use triggered abilities ([free], [reaction], and [action] abilities) from the following sources:</p>
...
<p>A card with the ✷ symbol before its card title is a unique card. There can be no more than one instance of each unique card, by title, in play at any given time.</p>
...
<p>Wild icons committed to a skill test are considered "matching" icons for the purposes of card abilities.</p>
...
<li>  A <b>Revelation</b> ability that references "you/your" refers to the investigator who drew the card and is resolving the ability.</li>

<li>  When resolving a triggered ability ([fast], [reaction], or [action] ability), "you/your" refers to the investigator triggering the ability.</li>
...
<p><i>"<b>Revelation</b> - Put Dreams of R’lyeh into play in your threat area.
<br>You get –1 [willpower] and –1 sanity.
<br>[action]: Test [willpower] (3). If you succeed, Discard Dreams of R’lyeh."</i></p>
...
<p><i>For example: The [reaction] ability on Survival Knife triggers "after an enemy attack deals damage to you during the enemy phase." This ability triggers even if the damage from that attack is assigned to one or more of your assets, and not your investigator card. However, if all of the damage from that attack is assigned to another investigator or their assets (through the use of a card effect that allows them to do so), then no damage has been dealt to you.</i></p>
...
<p>The red boxes are player windows. Players may use [free] triggered abilities in these windows.</p>
...
<tr><td class="green">1.1 Round begins. Mythos phase begins.</td></tr>
<tr><td class="green">1.2 Place 1 doom on the current agenda.</td></tr>
<tr><td class="green">1.3 Check doom threshold.</td></tr>
<tr><td class="green">1.4 Each investigator draws 1 encounter card.</td></tr>
<tr><td class="red">[free] PLAYER WINDOW</td></tr>
<tr><td class="green">1.5 Mythos phase ends.</td></tr>
<tr><td class="grey">Proceed to Investigation Phase.</td></tr>
<tr><td></td></tr>
<tr><th>II. Investigation phase</th></tr>
<tr><td class="green">2.1 Investigation phase begins.</td></tr>
<tr><td class="red">[free] PLAYER WINDOW</td></tr>
<tr><td class="green">2.2 Next investigator's turn begins.</td></tr>
<tr><td class="red">[free] PLAYER WINDOW</td></tr>
<tr><td class="green">2.2.1 Active investigator may take an action, if able. If an action was taken, return to previous player window. If no action was taken, proceed to 2.2.2.</td></tr>
<tr><td class="green">2.2.2 Investigator's turn ends. If an investigator has not yet taken a turn this phase, return to 2.2. If each investigator has taken a turn this phase, proceed to 2.3.</td></tr>
<tr><td class="green">2.3 Investigation phase ends.</td></tr>
<tr><td class="grey">Proceed to Enemy Phase.</td></tr>
<tr><td></td></tr>
<tr><th>III. Enemy phase</th></tr>
<tr><td class="green">3.1 Enemy phase begins.</td></tr>
<tr><td class="green">3.2 Hunter enemies move.</td></tr>
<tr><td class="red">[free] PLAYER WINDOW</td></tr>
<tr><td class="green">3.3 Next investigator resolves engaged enemy attacks. If an investigator has not yet resolved enemy attacks this phase, return to previous player window. After final investigator resolves engaged enemy attacks, proceed to next player window.</td></tr>
<tr><td class="red">[free] PLAYER WINDOW</td></tr>
<tr><td class="green">3.4 Enemy phase ends.</td></tr>
<tr><td class="grey">Proceed to Upkeep Phase.</td></tr>
<tr><td></td></tr>
<tr><th>IV. Upkeep phase</th></tr>
<tr><td class="green">4.1 Upkeep phase begins.</td></tr>
<tr><td class="red">[free] PLAYER WINDOW</td></tr>
<tr><td class="green">4.2 Reset actions.</td></tr>
<tr><td class="green">4.3 Ready each exhausted card.</td></tr>
<tr><td class="green">4.4 Each investigator draws 1 card and gains 1 resource.</td></tr>
<tr><td class="green">4.5 Each investigator checks hand size.</td></tr>
<tr><td class="green">4.6 Upkeep phase ends. Round ends.</td></tr>
<tr><td class="grey">Proceed to Mythos Phase of next game round.</td></tr>
</tbody></table>
...
<br>  If the card is a <strong>treachery</strong>, place the card in the encounter discard pile unless otherwise instructed by the ability.</li>
...
<li>  <strong>Activate</strong> an [action]-costed ability on an in-play card you control, an in-play encounter card at your location, a card in your threat area, the current act card, or the current agenda card.</li>
...
</p><strong>Important:</strong> When an investigator is engaged with one or more enemies and takes an action other than to <strong>fight</strong>, to <strong>evade</strong>, or to activate a <strong>parley</strong> or <strong>resign</strong> ability, each of those enemies makes an attack of opportunity against the investigator, in the order of the investigator's choosing.</p>

</p>After an investigator takes an action, return to the previous player window. An investigator may end his or her turn early if there are no other actions he or she wishes to perform. If the investigator does not or cannot take an action, proceed to 2.2.2.</p>
...
<tr><td class="green">ST.1 Determine skill of test. Skill test of that type begins.</td></tr>
<tr><td class="red">[free] PLAYER WINDOW</td></tr>
<tr><td class="green">ST.2 Commit cards from hand to skill test.</td></tr>
<tr><td class="red">[free] PLAYER WINDOW</td></tr>
<tr><td class="green">ST.3 Reveal chaos token.</td></tr>
<tr><td class="green">ST.4 Resolve chaos symbol effect(s).</td></tr>
<tr><td class="green">ST.5 Determine investigator's modified skill value.</td></tr>
<tr><td class="green">ST.6 Determine success/failure of skill test.</td></tr>
<tr><td class="green">ST.7 Apply skill test results.</td></tr>
<tr><td class="green">ST.8 Skill test ends.</td></tr>
</tbody></table>
...
<p>See also "<a href="#Resolving_Multiple_Revealed_Chaos_Tokens">Resolving Multiple Revealed Chaos Tokens</a>" above.</p>

<h3>ST.4 Apply chaos symbol effect(s).</h3>

<p>Apply any effects initiated by the symbol on the revealed chaos token. Each of the following symbols indicates that an ability on the scenario reference card must initiate: [skull], [cultist], [tablet], or [elder_thing].</p>

<p>The [elder_sign] symbol indicates that the [elder_sign] ability on the investigator card belonging to the player performing the test must initiate.</p>
...
<li>  If an investigator automatically fails at a test via a card ability or revealing the [auto_fail] symbol, his or her total skill value for that test is considered 0.</li>

</ul>

<p>See also "<a href="#Automatic_Failure_Success">Automatic Failure/Success - expanded</a>" above.</p>
...
<strong><li>  Choose investigators.</li></strong> Each player chooses a different investigator, and places that investigator's card in his or her play area.

<strong><li>  Take trauma damage/horror.</li></strong> In campaign play, each player places damage equal to his or her physical trauma, and horror equal to his or her mental trauma, on his or her investigator card.

<strong><li>  Choose one of those investigators to be the lead investigator for this game.</li></strong>

<strong><li>  Assemble and shuffle the investigator decks.</li></strong>

<strong><li>  Assemble token pool.</li></strong> Place the damage, horror, clue/doom, and resource tokens within easy reach of all players.

<strong><li>  Assemble the chaos bag.</li></strong> Place the chaos tokens indicated by the campaign setup instructions into the bag, and return the other chaos tokens to the game box.
...
<strong><li>  Collect starting resources.</li></strong> Each investigator gains 5 resources from the token pool.

<strong><li>  Draw opening hands.</li></strong> Each player draws 5 cards. Each player, in player order, may mulligan once at this time.
...
<strong><li>  Read the scenario introduction in the campaign guide.</li></strong>

<strong><li>  Perform the scenario setup instructions indicated by the campaign guide.</li></strong> This includes gathering the encounter sets listed in the setup instructions in the campaign guide, placing locations, placing investigator mini cards at the location each investigator begins play at, setting aside any listed cards, and shuffling remaining encounter cards together to form the encounter deck.

<strong><li>  Set agenda deck.</li></strong> Assemble the agenda deck in sequential order, with the art side faceup, so that "agenda 1a" is on top. Read the story text on agenda 1a.

<strong><li>  Set act deck.</li></strong> Assemble the act deck in sequential order, with the art side faceup, so that "act 1a" is on top. Read the story text on act 1a.

<strong><li>  Place the scenario reference card next to the agenda deck.</li></strong>
...
<li><strong>Skills:</strong> This investigator's value for his or her skills, in order: Willpower ([willpower]), Intellect ([intellect]), Combat ([combat]), Agility ([agility]).</li>
